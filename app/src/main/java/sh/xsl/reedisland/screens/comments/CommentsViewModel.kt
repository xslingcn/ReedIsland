...
class CommentsViewModel @Inject constructor(
    ...
    var currentPostFid: String = DawnConstants.TIMELINE_FORUM_ID
        private set
    ...
    fun getLocalQuote(
        ...
        commentList.find { it.id == id } ?: commentRepo.getHeaderPost(id)
    ...
    fun clearCache(clearFilter: Boolean, clearEverything: Boolean = false) {
        ...
        if (clearEverything) {
            ...
            currentPostFid = DawnConstants.TIMELINE_FORUM_ID
            currentPostId = "0"
        }
    }
